...
export const skills: Skill[] = [
  ...
  { label: 'Sonstiges',  icon: null,                             years: 1, level: 60, color: TEAL,   span: 2, note: { de: 'Tailwind, Bootstrap, Supabase, Vite und React Native gehören ebenfalls zu meinen Praxis-Tools.', en: 'I have also worked with Tailwind, Bootstrap, Supabase, Vite, and React Native.' }, noteShort: { de: 'Weitere Praxis-Tools: Tailwind, Supabase, Vite, React Native.', en: 'Additional tools: Tailwind, Supabase, Vite, React Native.' } },
];
